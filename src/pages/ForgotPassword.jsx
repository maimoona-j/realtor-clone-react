...
function onchange(e){
  ...
  return (
    <section>
  <h1 className='text-3x text-center mt-6 font-bold'>Forgot Password</h1>
...
<form className='w-full md:w-[67%] lg: w-[40%] lg:ml-20'>
    ...
    <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
        <p className='mb-6'>Don't have an account?
             <Link to="/sign-in"
              className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1'>Sign In instead</Link>
        </p>
        <p>
