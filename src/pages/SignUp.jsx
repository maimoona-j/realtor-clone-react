...
navigate("/")
  ...
  return (
    <section>
  <h1 className='text-3x text-center mt-6 font-bold'>Sign Up</h1>
   <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
    <div className='md: w-[67%] lg: w-[50%] mb-12 md:mb-6'>
        <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8a2V5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=1000&q=60" alt="key"  className='w-full rounded-2x1'/>
    </div>

    <div>
<form className='w-full md:w-[67%] lg: w-[40%] lg:ml-20' onSubmit={onSubmit}>
...
<input type="text"   id='name' value={name} onChange={onchange} placeholder="Full Name" className="mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"/>
    ...
    <input type= {showPassword ? "text": "password" }  id='password' value={email} onChange={onchange} placeholder="password" className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"/> 
